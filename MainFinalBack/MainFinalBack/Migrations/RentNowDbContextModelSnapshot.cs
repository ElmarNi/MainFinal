...
namespace MainFinalBack.Migrations
{
    ...
    partial class RentNowDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MainFinalBack.Models.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MainFinalBack.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MainFinalBack.Models.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MainFinalBack.Models.OurPassionAboutUs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("SectionBannerImage");
                    ...
                    b.ToTable("OurPassions");
                });

            modelBuilder.Entity("MainFinalBack.Models.OurVisionAboutUs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MainFinalBack.Models.SectionBanner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("SectionBanners");
                });

            modelBuilder.Entity("MainFinalBack.Models.TermContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("TermHeaderId");

                    b.HasKey("Id");

                    b.HasIndex("TermHeaderId");

                    b.ToTable("TermContents");
                });

            modelBuilder.Entity("MainFinalBack.Models.TermHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MainFinalBack.Models.Chat", b =>
                {
                    b.HasOne("MainFinalBack.Models.Order", "Order")
                        .WithOne("Chat")
                        .HasForeignKey("MainFinalBack.Models.Chat", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("MainFinalBack.Models.ChatMessage", b =>
                {
                    b.HasOne("MainFinalBack.Models.Chat", "Chat")
                    ...
                    b.HasOne("MainFinalBack.Models.Message", "Message")
                        .WithOne("ChatMessage")
                        .HasForeignKey("MainFinalBack.Models.ChatMessage", "MessageId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("MainFinalBack.Models.TermContent", b =>
                {
                    b.HasOne("MainFinalBack.Models.TermHeader", "TermHeader")
                        .WithMany("TermContents")
                        .HasForeignKey("TermHeaderId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
